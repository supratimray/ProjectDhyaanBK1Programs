...
elseif strcmpi(analysisType,'conn')
    electrodeGroupList{1} = [16 32+[14 15]];                               groupNameList{1} = 'Occipital_L'; % Occipital
    electrodeGroupList{2} = [18 32+[17 18]];                               groupNameList{2} = 'Occipital_R'; % Occipital

    electrodeGroupList{3} = [6:8 11 12 14 32+[7:9 11:13]];                 groupNameList{3} = 'Central_L'; % Central
    electrodeGroupList{4} = [19 20 22 23 25 28 29 32+[19 20 22 24:26]];    groupNameList{4} = 'Central_R'; % Central
    ...
    electrodeGroupList{7} = [1 3 4 32+[1 2 4 5]];                          groupNameList{7} = 'Frontal_L'; % Frontal
    electrodeGroupList{8} = [30:32 32+[28:31]];                            groupNameList{8} = 'Frontal_R'; % Frontal
end
