...
In addition, the program runDisplayBadElecsAcrossSubjectsBK1 displays the bad electrodes and bad subjects for the full dataset. This program is used to determine which subjects have too many bad electrodes.