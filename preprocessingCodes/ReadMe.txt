...
Codes are provided only for completeness. The eventual outcome of the codes is the generation of data that is available in the segmentedData folder. Since this data is already provided, these codes do not need to be run again
